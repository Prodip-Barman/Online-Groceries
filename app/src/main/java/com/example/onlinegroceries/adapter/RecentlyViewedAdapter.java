...
import com.example.onlinegroceries.ProductDetails;
...
public class RecentlyViewedAdapter extends RecyclerView.Adapter<RecentlyViewedAdapter.RecentlyViewedViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecentlyViewedViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("image", recentlyViewedList.get(position).getBegImageUrl());
    ...
    public static class RecentlyViewedViewHolder extends RecyclerView.ViewHolder{
        ...
        public RecentlyViewedViewHolder(@NonNull View itemView) {
            ...
            bg = itemView.findViewById(R.id.recentlyLayout);
        }
    }
}
